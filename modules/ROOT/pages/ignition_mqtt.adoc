...
* Conectar usando las credenciales `sangabriel.edge.transmission`

*Verificación de Topics Sparkplug B*:

* Los topics siguen el patrón: `spBv1.0/Cempro/NDATA/San Gabriel`
...
. Añadir tags al Tag Provider `CEM_UNS` bajo la ruta `Cempro/San Gabriel`
